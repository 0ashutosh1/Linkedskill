  ...
  if (loading) {
    return (
      <div className="bg-white lg:bg-transparent rounded-2xl p-4 lg:p-0 shadow-sm lg:shadow-none">
        <h3 className="text-sm font-semibold mb-3">Connected Experts</h3>
    ...
    return (
      <div className="bg-white lg:bg-transparent rounded-2xl p-4 lg:p-0 shadow-sm lg:shadow-none">
        ...
        <div className="text-center py-6">
          ...
          <p className="text-xs text-gray-500">No connected experts yet</p>
  ...
  return (
    <div className="bg-white lg:bg-transparent rounded-2xl p-4 lg:p-0 shadow-sm lg:shadow-none">
      <div className="flex items-center justify-between mb-3">
        <h3 className="text-sm font-semibold">Connected Experts</h3>
      ...
      <div className="space-y-3">
        {displayedExperts.map((expert) => (
          ...
          >
            ...
            <button
              ...
              className="w-8 h-8 rounded-full bg-purple-100 hover:bg-purple-200 flex items-center justify-center transition-colors opacity-0 group-hover:opacity-100"
              title="Start chat"
            >
        ...
        {connectedExperts.length > 3 && (
          <button
            ...
            className="w-full text-xs text-purple-600 hover:text-purple-700 font-medium py-2 rounded-lg hover:bg-purple-50 transition-colors"
          >
            {showAll ? (
