                      ...
                      {formData.areasOfInterest.length > 0 ? (
                        <div className="flex flex-wrap gap-2">
                          {formData.areasOfInterest.map((interest, index) => (
                            <div
                              key={index}
                              className="flex items-center gap-2 px-3 py-2 bg-indigo-900/20 border border-indigo-700/30 text-indigo-300 rounded-full text-sm font-medium group hover:bg-indigo-800/30 transition-colors"
                            >
                              <span>{interest}</span>
                              <button
                                type="button"
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    className="bg-white/15 hover:bg-white/25 px-4 py-2 rounded-lg text-sm font-medium transition-colors flex items-center gap-2"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex gap-2 pt-2">
                          ...
                          <button
                            ...
                            className="px-4 py-2 border border-slate-600 text-gray-300 text-sm font-medium rounded-lg hover:bg-slate-700/50 transition"
                          >
                            Cancel
                          </button>
                        </div>
