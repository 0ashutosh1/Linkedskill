  ...
  return (
    <div className="py-3 sm:py-4 lg:py-6 h-full flex flex-col">
      ...
      <div className="hidden lg:flex items-center gap-3 mb-6 lg:mb-8 px-4 lg:px-6">
        ...
        />
        <div>
          <div className="text-base lg:text-lg font-semibold text-purple-600">LinkedSkill</div>
      ...
      <nav className="space-y-1 sm:space-y-2 px-2 sm:px-3 lg:px-4 mb-6 lg:mb-8">
        ...
        <NavItem 
          ...
          svg={<svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 sm:w-6 sm:h-6 text-purple-500" viewBox="0 0 20 20" fill="currentColor"><path d="M13 7a2 2 0 11-4 0 2 2 0 014 0z" /><path d="M6 8a3 3 0 100-6 3 3 0 000 6zM6 10a4 4 0 00-4 4v1h8v-1a4 4 0 00-4-4z" /></svg>} 
        />
        <NavItem 
          label="Add Class" 
      ...
      <div className="mb-6 lg:mb-8 px-3 lg:px-4">
        ...
        <ul className="space-y-2 lg:space-y-3">
          <li className="flex items-center gap-3 cursor-pointer hover:bg-gray-50 p-2 lg:p-3 rounded-lg transition-all duration-200 hover:scale-102 active:scale-98" 
              onClick={() => onFriendClick && onFriendClick({ id: 'andrew', name: 'Andrew Meter', role: 'Software Developer' })}>
            <img 
              src="/src/assets/placeholder.svg" 
              alt="Andrew Meter" 
              className="w-10 h-10 lg:w-11 lg:h-11 rounded-full object-cover ring-2 ring-gray-100 hover:ring-purple-200 transition-all" 
            />
            <div className="min-w-0 flex-1">
              <div className="text-sm lg:text-base text-gray-800 font-medium truncate">Andrew Meter</div>
          ...
          <li className="flex items-center gap-3 cursor-pointer hover:bg-gray-50 p-2 lg:p-3 rounded-lg transition-all duration-200 hover:scale-102 active:scale-98" 
            ...
            />
            <div className="min-w-0 flex-1">
              <div className="text-sm lg:text-base text-gray-800 font-medium truncate">Jeff Linkoln</div>
      ...
      <div className="px-3 lg:px-4">
        <div className="flex items-center gap-3 text-red-500 cursor-pointer hover:text-red-600 p-2 lg:p-3 rounded-lg hover:bg-red-50 transition-all duration-200 hover:scale-102 active:scale-98 border border-red-200 hover:border-red-300" 
...
function NavItem({label, svg, onClick}){
  return (
    <div 
      onClick={onClick} 
      className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 lg:p-3 rounded-lg hover:bg-gray-50 hover:shadow-sm cursor-pointer 
    ...
    >
      ...
      <div className="text-sm sm:text-base lg:text-sm xl:text-base text-gray-700 font-medium group-hover:text-gray-900 transition-colors">
        {label}
      </div>
    </div>
  )
